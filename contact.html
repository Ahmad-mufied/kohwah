...
<nav class="bg-MyHero text-white pb-2">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="space-x-2">
            ...
            <a href="login.html">
                <button class="bg-transparent border border-white px-4 py-2 rounded hover:bg-white hover:text-black">Log
                    In
                </button>
            </a>
...
<div class="isolate bg-white px-6 py-12 sm:py-16 lg:px-8">
    ...
    <form action="contactSQL.php" method="POST" class="mx-auto mt-8 max-w-xl sm:mt-16">
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                <div class="mt-2.5 bg-MyHero">
                    <input type="submit" name="submit" id="submit" value="Let's Talk"
                           class="block w-full text-center text-sm font-semibold text-white shadow-sm rounded-md border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
        </div>
    </form>
