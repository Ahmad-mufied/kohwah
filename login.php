    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="space-x-2">
            <a href="cart.html"><button class="bg-transparent border border-white px-4 py-2 rounded hover:bg-white hover:text-black max-w-sm">
                    Cart (<span>0</span>)
                </button></a>            <a href="login.html"><button class="bg-transparent border border-white px-4 py-2 rounded hover:bg-white hover:text-black">Log In</button></a>
...
<div class="min-h-screen text-gray-900 flex justify-center mb-16 mt-4">
    <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div>
                <img src="/images/coffee-simple-logo-bgHero.png" alt="Coffee Shop"
                     class="w-48 mx-auto" />
            </div>
